    ...
    <script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=63d6a66c18afab8474652657" type="text/javascript" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
    ...
    <script>
      !(function (t) {
          ...
          function (t, e, n) {
              ...
              var R = { clone: c, addLast: l, addFirst: d, removeLast: p, removeFirst: v, insert: h, removeAt: E, replaceAt: _, getIn: y, set: g, setIn: m, update: I, updateIn: T, merge: O, mergeDeep: b, mergeIn: A, omit: S, addDefaults: w };
              e.default = R;
          },
          function (t, e, n) {
              var r = n(5).Symbol;
          ...
          function (t, e, n) {
              ...
              window.tram = (function (t) {
                  ...
                  var z = t.style,
                      ...
                      q = {};
                  C.transform && ((Q.transform = [k]), (q = { x: [I, "translateX"], y: [I, "translateY"], rotate: [T], rotateX: [T], rotateY: [T], scale: [y], scaleX: [y], scaleY: [y], skew: [T], skewX: [T], skewY: [T] })),
          ...
          function (t, e, n) {
              ...
              function at(t) {
                  ...
                  i && n.dispatch((0, y.rawDataImported)(i)),
                      u.active ||
                          (n.dispatch(
                              (0, y.sessionInitialized)({ hasBoundaryNodes: Boolean(document.querySelector(A)), reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches })
                          ),
                          o &&
                              ((function (t) {
                                                                                    ...
                                                                                    n.forEach(function (t) {
                                                                                        ...
                                                                                        if (o) {
                                                                                            ...
                                                                                            if (
                                                                                                ...
                                                                                                _[u] = !0;
                                                                                                var c = t.config;
                                                                                                x({ config: c, event: h, eventTarget: i, elementRoot: a, elementApi: g }).forEach(function (t) {
                  ...
                  if (f && f.useFirstGroupAsInitialState) {
                      ...
                      l.forEach(function (t) {
                          ...
                          s.forEach(function (i) {
                              ...
                              yt({ destination: L({ element: i, actionItem: t, elementApi: g }, o), immediate: !0, store: e, element: i, eventId: r, actionItem: t, actionListId: n, pluginInstance: o });
                          });
                      });
                  }
              }
              ...
              function yt(t) {
                  ...
                  var R = X(c, A, i, s, g, l);
                  r.dispatch((0, y.instanceAdded)((0, a.default)({ instanceId: _, elementId: b, origin: R, refType: S, skipMotion: w, skipToValue: n }, o))),
          ...
          function (t, e, n) {
              ...
              var f = s(n(272)),
                  ...
                  vt = Object.freeze(
                      ((i = {}), (0, c.default)(i, y.TRANSFORM_PREFIXED, I), (0, c.default)(i, D, m), (0, c.default)(i, x, x), (0, c.default)(i, C, C), (0, c.default)(i, P, P), (0, c.default)(i, M, M), (0, c.default)(i, L, L), i)
                  ),
                  ht = {},
                  Et = 1;
              var _t = 1;
              ...
              function mt(t) {
                  ...
                  var N,
                      ...
                      M = o && l(gt(o.target));
                  if ((P ? ((N = L.limitAffectedElements), (x = M), (C = l(L))) : (x = C = l({ id: T, selector: b, selectorGuids: A })), o && w)) {
                      var D = a && (C || !0 === w) ? [a] : d(M);
                      if (C) {
                          if (w === k)
          ...
          function (t, e, n) {
              ...
              t.exports = function (t, e, n) {
                  ...
                  return (
                      (e = o(e) || 0),
                      r(n) && ((E = !!n.leading), (l = (_ = "maxWait" in n) ? u(o(n.maxWait) || 0, e) : l), (y = "trailing" in n ? !!n.trailing : y)),
                      (O.cancel = function () {
      ...
      Webflow.require("ix2").init({
          events: {
              e: {
                  ...
                  target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "63d6a66c18afab5c6a652656|068575fd-1228-fb45-0342-a28746c2ffe3" },
                  targets: [],
                  config: [{ continuousParameterGroupId: "a-p", smoothing: 94, startsEntering: false, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
                  createdOn: 1675047216276,
              },
          },
          actionLists: {
              a: {
                                  ...
                                  actionItems: [
                                      {
                                          ...
                                          config: {
                                              ...
                                              easing: "",
                                              duration: 500,
                                              target: { useEventTarget: "CHILDREN", selector: ".grid", selectorGuids: ["08007aee-3a1c-47cb-4118-befe9eb80f4f"] },
                                              zValue: 0,
                                              xUnit: "DEG",
                                              yUnit: "DEG",
                                              zUnit: "deg",
                                      ...
                                      },
                                      {
                                          ...
                                          config: {
                                              ...
                                              easing: "",
                                              duration: 500,
                                              target: { useEventTarget: "CHILDREN", selector: ".video", selectorGuids: ["f1dcda6c-8cdd-2644-6f63-993c9bcf02d8"] },
                                              zValue: 0,
                                              xUnit: "DEG",
                                              yUnit: "DEG",
                                              zUnit: "deg",
                                      ...
                                      },
                                      {
                                          ...
                                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".grid", selectorGuids: ["08007aee-3a1c-47cb-4118-befe9eb80f4f"] }, xValue: 1, yValue: 1, locked: true },
                                      },
                                  ],
                              },
                              {
